...
#$compiler -v $2 -Iinclude/applib/ovxinc/include/ -Iinclude/service/ovx_inc/  -Llib/ -lovxlib -ljpeg_t -lvnn_inceptionv3 -Wl,-rpath,vendor/lib/
$compiler main_all.c -Iinclude/applib/ovxinc/include/ -Iinclude/service/ovx_inc/  -Llib/ -lovxlib -ljpeg_t -Wl,-rpath,vendor/lib/
rm $p/$compiler
