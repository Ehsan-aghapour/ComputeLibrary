...
XX=clang++ CC=clang scons --debug=explain Werror=0 -j8 debug=0 asserts=0 neon=1 opencl=1 os=android arch=arm64-v8a benchmark=1 benchmark_tests=1 LINKFLAGS='-llog'
r=$?
